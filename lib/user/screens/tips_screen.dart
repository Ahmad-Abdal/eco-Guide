  ...
  Widget build(BuildContext context) {
    return Center(
      child: Column(
        ...
        children: [
          const Icon(Icons.lightbulb_outline_rounded, size: 48, color: darkTeal),
          const SizedBox(height: 12),
          const Text('Tips', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: darkText)),
